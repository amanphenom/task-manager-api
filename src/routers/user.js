...
//         await user.save()
//         // Since below bypasses the mongoose middleware and validations, we'll
//         // replace this with above code. This code was written before the above code.
...
const avatar = multer({
    //dest: 'avatars', // IF we want to store files on our file system
    limits: {
        fileSize: 1000000
    },
